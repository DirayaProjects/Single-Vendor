/*
  ...
  SuperAdmin: see also Scripts/SeedSuperAdminRole.sql or add (N'SuperAdmin', N'SUPERADMIN') to the MERGE below.
  =============================================================================
*/
...
/* -------------------------------------------------------------------------- */
DECLARE @AdminEmail NVARCHAR(256) = N'you@example.com';  /* <<< CHANGE THIS */
...
PRINT N'OK: AspNetRoles seeded (incl. SuperAdmin); Admin assigned for ' + @AdminEmail + N'; users without roles got Customer.';
PRINT N'Optional: assign SuperAdmin with Scripts/SeedSuperAdminRole.sql';
